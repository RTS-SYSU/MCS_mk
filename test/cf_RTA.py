...
def run_schedulability_experiment():
    ...
    GEN_PARAMS = {
        ...
        'm': None, 'k': None, 'targetU': 0.65
    }

    # 利用率范围: 0.5 到 0.9 (步长 0.05)
    # range(10, 19) -> 10, 11, ..., 18 -> 0.40, 0.55, ..., 0.90
    u_steps = [1, 1.2, 1.4, 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3]
    ...
    # 1. 保存汇总表
    filename_main = f"rta_cf_{NUM_CORES}core"
